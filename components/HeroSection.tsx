...
export default function HeroSection({
  ...
  return (
    <section
      className={`relative min-h-screen flex items-center justify-center overflow-hidden ${darkMode ? "bg-slate-950" : "bg-gradient-to-br from-slate-50 to-violet-50"
        }`}
    >
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className={`absolute -top-40 -right-40 w-96 h-96 rounded-full blur-3xl opacity-20 ${darkMode ? "bg-violet-600" : "bg-violet-400"
            } animate-pulse`}
        />
        <div
          className={`absolute -bottom-40 -left-40 w-96 h-96 rounded-full blur-3xl opacity-20 ${darkMode ? "bg-indigo-600" : "bg-indigo-400"
            } animate-pulse`}
          style={{ animationDelay: "1s" }}
        />
        <div
          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full blur-3xl opacity-5 ${darkMode ? "bg-violet-500" : "bg-violet-300"
            }`}
        />
        {/* Grid pattern */}
        <div
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Badge */}
        <div
          className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium mb-8 border ${darkMode
        ...
        {/* Heading */}
        <h1
          className={`text-5xl sm:text-6xl lg:text-7xl font-black mb-6 leading-tight ${darkMode ? "text-white" : "text-slate-900"
            }`}
        >
        ...
        {/* Subheading */}
        <p
          className={`text-xl sm:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed ${darkMode ? "text-slate-300" : "text-slate-600"
            }`}
        >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          ...
          <a
            ...
            className={`flex items-center gap-2 px-8 py-4 font-bold text-lg rounded-2xl border-2 transition-all duration-300 hover:scale-105 ${darkMode
        ...
        {/* Creator badge */}
        <div
          className={`inline-flex items-center gap-3 px-6 py-3 rounded-2xl border ${darkMode
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
          <ArrowDown
            className={`w-6 h-6 ${darkMode ? "text-slate-500" : "text-slate-400"
              }`}
          />
        </div>
      </div>
